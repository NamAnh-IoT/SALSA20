...
Cụ thể, ban đầu thuật toán sẽ tạo ra 1 ma trận 4x4<br>
[C1] [K1] [K2] [K3]<br>
[K4] [C2] [N1] [N2]<br>
[c1] [c2] [C3] [K5]<br>
[K6] [K7] [K8] [C4]<br>

Với <br>C là Constant (hằng số mặc định của thuật toán)
    <br>K là Key 32 bytes được tách thành 8 mảnh 32 bit
    <br>N là Nonce 8 bytes được tách thành 2 mảnh 32 bit
    <br>c là counter 8 bytes và tăng 1 sau mỗi lần chạy
